<template>
  <section class="p-5 mt-16 flex items-center flex-col" id="projects">

    <div class="container">
      <h2 class="text-3xl font-bold pb-12 flex items-center">
        <span class="text-yellow-500 mr-2">02.</span>PROJECTS
      ...
      <div class="grid grid-cols-3 md:grid-cols-4 xl:grid-cols-8 gap-4">
        ...
        <GameImage image="dine.webp" name="dine." color="#3e3d44" date="2020 - 2022" url="https://dine-app.at" />

<template>
	<section id="contact" class="py-20 px-5">
		<div class="container mx-auto max-w-3xl text-center">
			...
			<a href="mailto:hiebeler.daniel@gmail.com" class="bg-yellow-500 hover:bg-yellow-600 rounded-lg text-black px-8 py-3 text-lg hover:cursor-pointer">Say Hello</a>
		</div>
	</section>
</template>
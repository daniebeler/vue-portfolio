<template>
  <Topic topic="COLOR PALETTES" image="color-title.jpg" />
  ...
  <section class="first-section">
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col">
          <h5 class="text-cente">
            Finding the right color schemes for a project can be a difficult
            thing. Thats why I collected some great color palettes and maybe you
    ...
    <div class="container">
      <div class="row">
        <div class="col justify-content-center" style="display: flex">
          <h4>
            "There are harmonies and contrasts hidden in colors which
  ...
  <section>
    <div class="container">
      <div
        class="row text-center color-row g-0 pt-5 pb-5"
        v-for="color in colors"
      >
        <div class="col-3">
          <div class="color-first" :style="{ background: color[0] }"></div>
          <p>{{ color[0] }}</p>
        </div>
        <div class="col-3">
          <div class="color-second" :style="{ background: color[1] }"></div>
          <p>{{ color[1] }}</p>
        </div>
        <div class="col-3">
          <div class="color-third" :style="{ background: color[2] }"></div>
          <p>{{ color[2] }}</p>
        </div>
        <div class="col-3">
          <div class="color-last" :style="{ background: color[3] }"></div>
          <p>{{ color[3] }}</p>
        </div>
      </div>
    </div>
